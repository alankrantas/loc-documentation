...
Payload is the data sent by triggers as initial input and is accessible from the [context](/legacy/0.8/sdk-reference/context-and-task) object. Currently there are two payload types:
...
| `subscriber`            | [`Subscriber`](/legacy/0.8/sdk-reference/payload#subscriber-types) | MQ subscriber                   |
| `data`                  | `number[]`                                                         | MQ data                         |
