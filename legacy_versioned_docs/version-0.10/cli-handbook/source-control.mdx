...
There are _many ways_ to achieve collaboration with Git, and you can check out Git's [official documentation](https://git-scm.com/legacy/0.10/gittutorial) to learn more. Here we'll give you one of the most basic example.

:::tip
If you are developing with VS Code, you can also use the built-in source control functionalities. See: [Using Git source control in VS Code](https://code.visualstudio.com/legacy/0.10/sourcecontrol/overview).
:::
