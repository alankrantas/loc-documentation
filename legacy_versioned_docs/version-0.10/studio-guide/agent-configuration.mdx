...
**Agent Configuration** is part of the administration panel for creating and managing secrets for the following agents in [SDK](/legacy/0.10/category/sdk-reference):

-   [HTTP agent](/legacy/0.10/sdk-reference/http)
    -   Supports HTTP or HTTPS
    -   Can set authorization (None, Basic or Bear), custom headers and path prefix
-   [Database agent](/legacy/0.10/sdk-reference/database)
...
-   [File storage agent](/legacy/0.10/sdk-reference/filestorage)
    -   Supports FTP, Amazon S3 or SMB (Server Message Block)
-   [Mail agent](/legacy/0.10/sdk-reference/mail)
    -   Using a SMTP server
...
See the following tutorials for how to create and use an agent configurations in your data processe:
