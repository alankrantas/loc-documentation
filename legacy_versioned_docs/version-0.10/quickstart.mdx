...
flowchart TD;
    ...
    n3["Payload JSON Parser\n(generic logic)"]-->|parsed JSON|n4;
    n4["Greeting\n(generic logic)"]-->|greeting message|n5;
    end
    n5["Result Aggregator\n(aggregator logic)"]-->|finalised result|n6((JSON response));
```
