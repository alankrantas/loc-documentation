...
| Member                       | Type                                                                          | Description                |
| ---------------------------- | ----------------------------------------------------------------------------- | -------------------------- |
| `dataProcessIdentityContext` | `IdentityContext` (see [Context](/legacy/0.7/sdk-reference/context-and-task)) | Data process ID and name   |
...
`order` can be either `"asc"` (ascending order) or `"desc"` (descending order). Works for both numeric data or non-numeric strings (sorting alphabetically).
...
| `filter?`   | `Filter[]`   | Filter conditions (see [here](http://localhost:3000/legacy/0.7/sdk-reference/eventstore#example-filter-events-range)) |
...
The available field names in `conditions?` are the same as `search` (see [here](/legacy/0.7/sdk-reference/eventstore#example-query-events)). See the example for details.
...
| Member     | Type       | Description                                                                                             |
| ---------- | ---------- | ------------------------------------------------------------------------------------------------------- |
| `events`   | `Event[]`  | Queried events (same as the one used by [seqrch](/legacy/0.7/sdk-reference/eventstore#searched-events)) |
| `joinKeys` | `string[]` |                                                                                                         |
