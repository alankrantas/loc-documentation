...
The logs can be read in either [Execution History](/legacy/0.7/studio-guide/data-discovery#execution) panel of Studio or console output of [Local Simple Runtime](/legacy/0.7/cli-handbook/local-runtime) with CLI.
